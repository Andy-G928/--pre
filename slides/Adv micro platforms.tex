\documentclass[aspectratio=169,AutoFakeBold,AutoFakeSlant]{beamer}
...
% Presentation title:
%  1 short title displayed in the footer;
%  2 full title displayed on the title page.
\title[Platform Dual Mode]{
  Should Platforms Be Allowed to Sell\\
  on Their Own Marketplaces?}

% Author information:
%  1 short author information displayed in the footer;
...
%  1 short institute displayed in the header;
%  2 institute displayed on the title page.
\institute[Sun Yat-Sen University]{
  Sun Yat-Sen University}

%% Date information
%  1 short date displayed in the footer;
%  2 date displayed on the title page.
